...
<head>
  ...
  <title>OG Tech - Kullanıcı Yönetim Sistemi </title>
  <?php
    include "header.php"; 
    ...
    <div class="rounded-card-parent center" style="margin-bottom: 100px">
      <div class="card rounded-card">
        <div class="card-content white-text">
          <span class="card-title orange-text bold">Kullanıcı Listesi - En Yenilere Göre Sırala
            <button class='deep-orange btn'><a href="admin_manage_users.php"><i class='material-icons white-text'>tazele</i></a>
            </button>
          </span>

          <!-- üye girişi alanını ara başlatma -->
          <form id="search_user" action="admin_manage_users.php" method="POST">
            <div class="row" style="margin: 0px;">
              <div class="input-field col s3" style = "color:azure">
                ...
                <label for="search_member">Üyeyi isme göre ara  </label>
                <div class="errormsg">
                  <?php
                    if (isset($_GET["error"]))
                    {
          ...
          <!-- üye giriş alanı sonunu ara   -->
          
          <!-- üye sonuç listesini ara başlat    -->
        ...
        <!-- üye sonuç listesi sonunu aratmak     -->
        </div>
      </div>
    </div>
    <!--  kullanıcı listesinin sonu -->

    <!--  seçilen üye detayları başlatma  -->
    <?php if (isset($_GET["inspect"])) { ?>
      <div class="rounded-card-parent center">
        <div class="card rounded-card">
          <div class="card-content white-text">
            <span class="card-title orange-text bold"> Seçilen Üye Detayları </span>
            <table class="responsive-table">
              <form action="admin_manage_users.php" method="GET">
                <thead class="text-primary center">
                  <tr><th>MemberID</th><th>Username</th><th>Email</th><th> Ayrıcalık Düzeyi  </th></tr>
                </thead>
                <tbody>
    ...
    <div class="rounded-card-parent" style="margin-top: 100px">
      <div class="card rounded-card">
        <div class="card-content">
          <span class="card-title orange-text bold">Kullanıcı Oluştur</span>
          <form id="create" name="create" action="" method="post">
            <div class="row">
              <div class="input-field col s8 white-text">
                ...
                <span class="helper-text grey-text" data-error="Min 5, Max 12 characters" data-success="Min 5, Max 12 characters">Min 5, Max 12 Karakter</span>
                <label for="username" class="white-text"> Kullanıcı Adı</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s8 white-text">
                <i class="material-icons prefix"> Şifre</i>
                <input name="pwd" id="pwd" type="password" class="validate white-text" minlength="8" maxlength="20">
                <span class="helper-text grey-text" data-error="Min 8, Max 20 characters" data-success="Min 8, Max 20 characters">Min 8, Max 20 Karakter</span>
            ...
            <div class="row">
              <div class="input-field col s8 white-text">
                ...
                <label for="repeat_pwd" class="white-text"> Şifre Tekrar</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s8 white-text">
                <i class="material-icons prefix white-text">atama_ind</i>
                <select id="level" name="level">
                  <option value="" disabled selected>Choose your option</option>
                  <option value=1>Üye</option>
                  <option value=2>Admin</option>
                </select>
                <label class="white-text">Ayrıcalıklı Seviye</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s8 white-text">
