...
<div class="container" style="margin-top:150px">
	...
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		...
		<h4 style="color:white">Son 7 günün toplam satışları  : Tl<?php echo $data_tot = number_format((float)$data_tot, 2, '.', '');?></h4>
		<h4 style="color:white">Başlama Tarihi: <?php echo $date7?></h4>
		<h4 style="color:white">Bitiş Tarihi: <?php echo $date1?></h4>
	</div>
	<br><br><br>
	<h3 class="page-title">Satış Raporu</h3>
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		<h5 style="color:white">İndirim Grafiği</h5>
		<p style="color:white">Satışlar vs Aylık grafikler</p>
		<div>
		...
		?>
		<h4 style="color:white"> Son 90 gün içindeki toplam satış: TL<?php echo $month_tot = number_format((float)$month_tot, 2, '.', '');?></h4>
	</div>
	<br><br><br>
	...
	<h3 class="page-title">Kullanıcı girişi</h3>
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		<h5 style="color:white"> Kullanıcı bar</h5>
		<p style="color:white"> > Son 30 güne ait yeni kayıt sayısı </p>
		<div>
		...
		?>
		<h4 style="color:white"> Son 30 güne ait yeni kayıt sayısı   : <?php echo $quantity_user?> Kullanıcı/Kullanıcılar</h4>
	</div>
</div>
<script>
...
new Chart("myChart3", {
	...
	options: {
		...
		title:{
			display:false,
			text: "Her kategorideki stok miktarı    "
		}
	}
});
...
var xValues_u = ["UPSS Yeniden girin"];
