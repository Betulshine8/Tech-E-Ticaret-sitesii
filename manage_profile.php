...
<head>
  ...
  <title>OG Tech - Hesabı Yönet </title>
  <?php include "header.php"; ?>
</head>
<body>
<h3 class="page-title grid" style="margin-top: 50px;"> Kişisel Profili Yönet </h3>
  <div class="grid">
    ...
    <div class="rounded-card-parent black">
      <div class="card rounded-card black" style="width: 650px; ">
        <div class="row">
          <button id="edit" style="text-align:left" class="btn orange " onclick="confirm_edit(this)" style="margin-right: 20px">Düzenle</button>
          ...
          <form class="s12" action="includes/manage_profile.inc.php" method="POST">
            ...
            <div class="row">
              <div class="input-field s6">
                ...
                ?>
                <label class='cyan-text' for="email">Yeni Email girin</label>
            ...
            <div class="row">
              <div class="input-field s6">
                ...
                <label class='cyan-text' for="pwd">Yeni Şifre Girin</label>
            ...
            <div class="row">
              <div class="input-field s6">
                ...
                <label class='cyan-text' for="repeat_pwd"> Yeni Şifreyi Tekrarlayın</label>
              </div>
            </div>
          <br>
          <p class="center-align">
          <button disabled id="update_acc" type="submit" name="update" class="btn orange darken-4"> Hesabı Yükselt</button>
          </p>
          </form>
        </div>        
      </div>
