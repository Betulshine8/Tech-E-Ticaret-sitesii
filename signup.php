<!DOCTYPE html>
<html lang="en">
<title>OG Tech - Giriş Yapın</title>
<?php include "header.php"; ?>

<form action="includes/signup.inc.php" method="POST">
  <div class="container">
    <h3 class="underline white-text grid">Girişi Yapın</h3>
      ...
      <div class="card rounded-card">
        <div class="row">
          <div class="input-field col s4 offset-s4">
            ...
            <span class="helper-text grey-text left-align" data-error="Min 5, Max 12 characters" data-success="Min 5, Max 12 characters">Min 5, Max 12 Karakter</span>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s4 offset-s4">
            <i class="material-icons prefix white-text"> şifre</i>
            <input name="pwd" id="pwd" type="password" class="validate white-text" minlength="8" maxlength="20">
            <label for="pwd" class="white-text"> Şifre</label>
            <span class="helper-text grey-text left-align" data-error="Min 8, Max 20 characters" data-success="Min 8, Max 20 characters">Min 8, Max 20 Karakter</span>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s4 offset-s4">
            ...
            <label for="repeat_pwd" class="white-text"> Şifreyi Tekrarlayın</label>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s4 offset-s4">
