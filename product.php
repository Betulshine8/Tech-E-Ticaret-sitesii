...
<div class="container" style="margin-top: 50px;">
          ...
          <div class="col s8">
              ...
              <table class="responsive-table">
                <tbody>
                  ...
                  <tr>
                    ...
                    ?>
                    <!-- Ürün Detaylarının Sonu -->
                  </tr>
                  <h4 class="amber-text"><?php echo($displayPrice); ?></h4>
                  <tr><th class='grey-text'>Marka: </th><td><?php echo($brand); ?></td></tr>
                  <tr><th class='grey-text'>Açıklama: </th>
                    <td>
                      <?php 
                  ...
                  <tr><th class='grey-text'>Kategori: </th><td><?php echo($category); ?></td></tr>
                </tbody>
              </table>
            </div>

            <div class="row input-field grid">
              <a style="margin-right: 10px"><p class="grey-text">Garanti:</p></a>          
            ...
            <div class="row grid" style="margin-right: 10px">
              <button type="submit" class="btn waves-effect waves-light " onclick="return addToCart()">
                <a class="white-text">
                  <i class="material-icons right">alışveriş_kartı</i>
                  Kart Ekle 
                </a>
              </button>
  ...
  <div class="rounded-card-parent" style="margin-top: 50px;">
    <div class="card rounded-card">
      <h4 class="white-text" style="margin-bottom: 40px;">Görüntüle</h4>
