...
'MSI', '34 inç 3440x1440 Çerçevesiz tasarım - Nihai oyun deneyimi. 178 ° geniş görüş açısı. HDR 400 - En Ölçüt Formatına Sahip Çarpıcı Görseller. 1 ms tepki süresi - ekran yırtılmasını ve dalgalı kare hızlarını ortadan kaldırın. 144Hz Yenileme Hızı - Gerçek pürüzsüz oyun. Kavisli Oyun ekranı (1800R) – En iyi oyun deneyimi. UWQHD Yüksek Çözünürlük - Oyun başlıkları daha da iyi görünecek ve UWQHD çözünürlüğü nedeniyle daha fazla ayrıntı gösterecektir.                ', 1, 2888, 15, 'msı monitörü 2.jpg'),
(25, 'RAZER Kraken V2 Pro Kulaklık', 'Razer', 'Özel ayarlı 50 mm Sürücüler. Soğutma Jeli ile Doldurulmuş Yastıklar. Geri çekilebilir tek yönlü mikrofon. Net ve Güçlü Ses Daha Kalın Kafa bandı dolgusu Saatlerce Rahatça Çalar ', 1, 399.99, 20, 'razer kulaklık 2.jpg'),
(26, 'RAZER Blackwidow Klavye Yeşil Anahtarı 2019', 'Razer', ' Razer Green Oyun oynamak için tasarlanmış Mekanik Anahtarlar 80 milyon tuş vuruşu ömrü Razer Chroma 16,8 milyon renk seçeneğiyle özelleştirilebilir arka aydınlatma Hibrit Yerleşik Bellek ve Bulut Depolama - 5 profile kadar Razer Synapse 3 özellikli Kablo yönlendirme seçenekleri N tuş rulosu-dahili anti-gölgelenme ile Anında makro kaydı olan tamamen programlanabilir tuşlar Oyun modu seçeneği 1000 Hz Ultrapolling Anında Tetikleme Teknolojisi ', 2, 269.99, 15, 'razer klavye.jfıf'),
(27, 'RAZER Seirēn X - Black', 'Razer', 'Ultra Hassas Pikap Deseni Darbeye Dayanıklı Kompakt Form Faktörü', 2, 319.99, 10, 'razer mikrofon.jfıf'),
(28, 'RAZER RAPTOR 27 1440P 165 HZ', 'Razer', 'VESA UYUMLU ve kablo yönetimi. DÜNYANIN İLK THX® SERTİFİKALI OYUN MONİTÖRÜ. 165HZ YÜKSEK HIZ. QHD YÜKSEK ÇÖZÜNÜRLÜK. Gsync ve Freesync uyumludur. ', 1, 3199.99, 2, 'razer monitörü.jpg'),
(29, 'RAZER BASİLİSK V3', 'Razer', ' KAYDIRMAYI MÜKEMMELLEŞTİRME. TAM SPEKTRUM ÖZELLEŞTİRİLEBİLİRLİĞİ. 10 + 1 PROGRAMLANABİLİR DÜĞME. Profil değiştirme.                 ', 2, 259, 15, 'razer fare.jfıf'),

(30, 'RAZER Nommo Pro', 'Razer', 'SAĞLAM, sınırsız BAS. THX SERTİFİKALI PREMİUM SES. Birinci sınıf Stüdyo kalitesinde ses. GÜÇLÜ SİNEMATİK DALDIRMA dolby ses sertifikalı.', 1, 3098, 2, 'razer konuşmacısı.jfıf'),
(32, 'Viewsonic Elite XG350R-C 35 "Kavisli', 'Viewsonic', ' 100Hz yenileme hızı. ClearMotion arka ışık stroblama teknolojisi. 3440 X 1440 Ultra Geniş QHD çözünürlük. ELİT RGB İttifakı. Uyarlanabilir Senkronizasyon ve AMD FreeSync ™ teknolojisi.                 ', 1, 2077, 15, 'viewsonic monitörü.png'),
(33, 'Logitech G102 RGB fare', 'Logitech', ' 8.000 DPI. LIGHTSYNC RGB, ~ 16,8 milyon renkte özelleştirilebilen renk dalgası efektlerine sahiptir.                ', 2, 69.99, 30, 'logı fare.jpg'),
(34, 'LOGİTECH G502 Oyun Faresi', 'Logitech', 'Özelleştirilebilir ağırlığa sahip, dünyanın en çok satan faresi. rgb logolu 5 programlanabilir düğme. Dayanıklı malzemeler ve rahat mühendislik kavrama. 70 milyon tıklama ömrü.', 2, 159, 50, 'g502.jpg'),
(35, 'ACER Nitro VG270 27 \ "75hz', 'Acer', '1920x1080p IPS Freesync 1ms, sanal yanıt artışı ile 0,5ms'ye kadar', 1.719.99, 28, 'acer monitör.jfıf'),
(36, 'Acer Aopen 24CV1Y Monitör (23,8 \ ")', 'Acer', 'Full HD, VA Panel, 5ms (GTG) Yanıt Süresi, 75Hz Yenileme Hızı', 1.499.30, 'acer bütçe monitörü.jfıf'),
(37, 'Steelseries QCK KENAR L - 450mm x 400mm x 2mm', 'Steelseries', ' Dünyanın en çok satan Kumaş Oyun Mouse Pad'lerinden biri. Son derece pürüzsüz ama dayanıklı.                ', 2, 60, 30, 'steelseries l.png'),
(38, 'Steelseries QCK EDGE - XL 900mm x 300mm x 2mm', 'Steelseries', 'Dünyanın en çok satan mouse matlarından biri. Yüksek kaliteli dokuma ve kauçuktan yapılmıştır. Kaymaz sırt ve pürüzsüz yüzey.', 2, 119, 50, 'steelseries xl.jfıf'),
(39, 'OGTECH OFİS BİLGİSAYARI KOMPAKT', 'Karışık', 'İşlemci: AMD Ryzen 5 PRO 4650G Anakart: ASROCK B550M ITX / AC (Wifi) RAM: GSKİLL AEGİS DDR4 3200Mhz (1 x8gb) SSD: GİGABYTE NVMe SSD 256GB Kasa: Psu'lu ANTEC ISK310-150 Mini-ITX KASA', 0, 2099, 10, 'kompakt bilgisayar.png');
...
--
-- Üyeleri ekleme Crud işlemlerini gerçeklerştirme
--
...
--
-- Üyelerin verilerini tabloya girmek`
--
...
--
-- Sipariş zamanının yapılarını tabloya girme
--
...
--
-- `Orderıtems` tablosu için veri dökümü
--
...
--
--  `Siparişler' tablosu için tablo yapısı
--
...
--
-- tablo `sipariş öğeleri' için kısıtlamalar `
--
ALTER TABLE `orderitems`
