...
<head>
  ...
  <title>OG Tech PC - Ürün Düzenlemeleri</title>
  <?php
    require "header.php";
...
<body>
  ...
  <div class="card rounded-card">
    <a class="btn blue darken-2" href='admin_manage_products.php' style="margin-bottom: 10px;"> ÜRÜNLERİ YÖNETMEYE GERİ DÖN</a>  </a>
    <span class="card-title orange-text bold center" style="padding-left: 100px;">Düzenlenmiş Ürün - <?php echo $name; ?></span>
    <form action="" method="POST" style="padding-left: 10px;">
      ...
      <div class="row">
          ...
          <div class="row">
            <div class="row">
              <div class="input-field white-text col s12">
                <i class="material-icons prefix">açılama</i>
        ...
        <div class="col s6" style="padding-right: 40px;">
          <div class="row">
            <div class="input-field white-text">
              <i class="material-icons prefix white-text">Kategoriler</i>
              <select name="category" id="category">
                <option value="" disabled selected>Seçeneğinizi belirleyin</option>
                <option value=0>PC Packages</option>
                <option value=1>Monitor & Audio</option>
                <option value=2>Peripherals</option>
              </select>
              <label class="white-text">Kategoriler</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field white-text">
              <i class="material-icons prefix">para_ekle</i>
              ...
              <label for="sellingprice" class="white-text">Satış Fiyatı</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field white-text">
              <i class="material-icons prefix white-text"> ürün_üretme_sınırı  </i>
              ...
              <label for="quantityinstock" class="white-text">Stoktaki Miktar  </label>
            </div>
          </div>
        </div>
      </div>
