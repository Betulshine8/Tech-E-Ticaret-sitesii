        ...
        <div class="col s12 m6">
          <div class="card blue darken-1" style="width: 340px;">
            <div class="card-content white-text" style="height: 160px;">
              <span class="card-title ">Girişler</span>
              <div class="grid">
            ...
            <div class="card-action left" style="width: 340px;">
              <a href="admin_report.php#user">Raporları Görüntüle</a>
              <a href="admin_manage_users.php">Kullanıcı Raporları</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style="width: 340px; height: 238px">
        <div class="col s12 m6">
          <div class="card amber darken-4" style="width: 340px;"> 
            <div class="card-content white-text" style="height: 160px;">
              <span class="card-title ">Ürünler</span>
              <div class="grid">
                <i class="material-icons white-text">Kategori</i>
                <?php 
            ...
            <div class="card-action left" style="width: 340px;">
              <a href="admin_report.php#product">Raporları Görüntüle</a>
              <a href="admin_manage_products.php"> Ürün Yönetimi</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col s12 m6">
          <div class="card green darken-1" style="width: 340px;">
            <div class="card-content white-text" style="height: 160px;">
              ...
              <div class="grid">
                <i class="material-icons white-text">Alışveriş_ Kartı</i>
                <div id="order">
                  <?php 
            ...
            <div class="card-action left" style="width: 340px;">
              <a href="admin_report.php#order">Raporları Görüntüle</a>
              <a href="admin_view_orders.php">Sipariş Yönetimi</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style="width: 340px; height: 238px">
        <div class="col s12 m6">
          <div class="card red lighten-1" style="width: 340px;">
            <div class="card-content white-text" style="height: 160px;">
              <span class="card-title">Bugünün Siparişleri</span>
              <div class="grid">
                <div id="order1">
                  <?php 
                    $sql = "SELECT M.*, O.*, P.* FROM Members M, Orders O, Payment P
            ...
            <div class="card-action center">
              <a href="admin_view_orders.php">Yönetici</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-content white-text">
              <table class="responsive-table center" id="pagination">
                <thead class="text-primary center">
                  <tr>
                    <h5 class="white-text bold" style="padding-bottom: 20px">Ürün İncelemeleri </h5>
                  </tr>
                </thead>
                <tbody>
                  <?php 
