...
<head>
  ...
  <title>İncelemenizi yapın </title>
  <?php
    include "header.php";
        ...
        <div class="row">
          <div class="col s9">
            <div class="grid left">
              ...
              <h4 class="amber-text bold grid">Ürünü Değerlendir </h4>
            </div>
          </div>
        </div>
...
<script>
  ...
  $(document).ready(function() 
  {
    ...
    // derecelendirmenin başlangıç koşulu (veritabanından)
