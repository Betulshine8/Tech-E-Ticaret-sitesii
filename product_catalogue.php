...
<body>
  <head>
    ...
    <title>OG Tech PC - Ürün Katalogu</title>
    <?php 
            ...
            <div class="section" style="margin-bottom: 100px;">
              <div class="col unglow">
                <ul id="filter_dropdown" class="dropdown-content black">
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Temizle</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">PC Paketleri</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Monitor & Audio</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Diğerleri</a></li>
                </ul>
            ...
            <div class="section" style="margin-bottom: 100px">
              <div class="col unglow">
                <ul id="sort_dropdown" class="dropdown-content black">
                  <li><a class="page-title" onclick="select_sort(this)">Temizle</a></li>
                  <li><a class="page-title" onclick="select_sort(this)">Yüksek fiyattan düşüğe/a></li>
                  <li><a class="page-title" onclick="select_sort(this)">Düşük Fİyattan Yükseğe</a></li>
                </ul>
            ...
            <div class="section">
              <div class="col unglow">
                <ul id="choose_dropdown" class="dropdown-content black">
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Temizle</a></li>
...
<script>
  ...
  {
    // geçerli onclick olay dizinini al
    var categoryID = categoryBy[selectedItem.textContent];
    //formu işlemek için geçerli eşlenen dizini ve çıktıyı GET yöntemiyle url'ye atayın 
