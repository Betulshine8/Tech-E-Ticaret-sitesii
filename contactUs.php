...
<head>
  ...
  <title>OG Tech - Bizimle İletişime Geçin</title>
        ...
        <div id="contactdetailscontainer">
            <div class="contactdetails">
                ...
                <p class="grey-text text-lighten-4 bold" style="margin:8px;font-size:16px">
                    <strong class="grey-text text-lighten-4 bold" style="font-size:22px">OG Solutions </strong><br>
        
                </p>
            </div>
            <div class="contactdetails">
                <div class="iconcontainer">
                    <i class="medium material-icons" style="font-size: 65px;">Telefon</i>
                </div>
                <p class="grey-text text-lighten-4 bold" style="margin:8px;font-size:22px">
                    <strong class="grey-text text-lighten-4 bold" style="font-size:23px">İletişim Numarası</strong><br>
                    90 -534567898
                </p>
            </div>
            <div class="contactdetails">
            ...
            <div class="contactdetails">
                ...
                <p class="grey-text text-lighten-4 bold" style="margin:8px;font-size:16px">
                    <strong class="grey-text text-lighten-4 bold" style="font-size:20px">İş stream_socket_enable_crypto</strong><br>
